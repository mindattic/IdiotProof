...
public class PreviousStrategyTests
{
    ...
    public void AllPreviousStrategies_RemainCompliant()
    {
        ...
        System.Console.WriteLine("              Previous Strategies Compliance Test               ");
        System.Console.WriteLine("================================================================");
        System.Console.WriteLine();
        ...
        System.Console.WriteLine($"Testing {strategies.Count} strategies...");
        System.Console.WriteLine();
        ...
        for (int i = 0; i < strategies.Count; i++)
        {
            ...
            try
            {
                ...
                System.Console.WriteLine($"  ✓ Strategy {i + 1}: {strategy.Symbol} - Valid ({strategy.Conditions.Count} conditions)");
            }
            catch (Exception ex)
            {
        ...
        if (errors.Count > 0)
        {
            System.Console.WriteLine($"FAILED: {errors.Count} strategy/strategies failed compliance.");
            Assert.Fail(string.Join(Environment.NewLine, errors));
        }
        else
        {
            System.Console.WriteLine($"PASSED: All {strategies.Count} strategies are compliant.");
        }
    }
}
