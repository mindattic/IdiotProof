...
public class StrategyConsoleManager
{
    ...
    // TODO: Add direct integration with TradingEngine when needed
    // private readonly TradingEngine? _engine;

    public StrategyConsoleManager(IEnumerable<StrategyDefinition>? initialStrategies = null)
    {
    ...
    private async Task CreateStrategyAsync()
    {
        ...
        if (StrategyScriptParser.TryParse(script, out var strategy, out var error))
        {
            ...
            // TODO: Direct sync with trading engine (IPC removed)
            // Strategies are now managed in-process
    ...
    private async Task RunBacktestAsync()
    {
        ...
        // TODO: Implement direct backtest invocation without IPC
        // Previously this used BackendClient.RunBacktestAsync() over IPC
        // Now should call BacktestService or AutonomousBacktestRunner directly
        System.Console.ForegroundColor = ConsoleColor.Yellow;
        System.Console.WriteLine("[INFO] Backtest feature being refactored for direct integration.");
        System.Console.WriteLine("       Use the main menu backtest options instead.");
        System.Console.ResetColor();
