...
namespace IdiotProof.Shared.Models
{
    ...
    public static class SegmentFactory
    {
        ...
        {
            SegmentCategory.Start => "≡ƒôì Start",
            SegmentCategory.Session => "ΓÅ░ Session",
            SegmentCategory.PriceCondition => "≡ƒÆ░ Price Conditions",
            SegmentCategory.VwapCondition => "≡ƒôè VWAP Conditions",
            SegmentCategory.IndicatorCondition => "≡ƒôê Indicators",
            SegmentCategory.Order => "≡ƒ¢Æ Orders",
            SegmentCategory.RiskManagement => "≡ƒ¢í∩╕Å Risk Management",
            SegmentCategory.PositionManagement => "≡ƒôñ Position Management",
            SegmentCategory.OrderConfig => "ΓÜÖ∩╕Å Order Config",
            _ => category.ToString()
        };
