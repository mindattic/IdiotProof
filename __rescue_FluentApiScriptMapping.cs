...
//
// CONVERSION FLOW:
//   Fluent API ΓåÆ TradingStrategy ΓåÆ (Backend execution)
//   IdiotScript ΓåÆ StrategyDefinition ΓåÆ IdiotScript (round-trip)
//   TradingStrategy Γåö StrategyDefinition (via JSON serialization)
//
...
public static class FluentApiScriptMapping
{
    ...
    [
        ...
        new(".IsVolumeAbove(multiplier)",
            ...
            "IndicatorCondition",
            "Volume above N├ù average (volume spike confirmation)"),
